...
authorized_names = ["amartya","max","sofi","riana"]  # Replace with names you wish to authorise THIS IS CASE-SENSITIVE
...
def process_frame(frame):
    ...
    for face_encoding in face_encodings:
        ...
        if name == "Unknown":
            no_known_face = f"I cannot see a known face"
            subprocess.run(["espeak","-ven+f1","-s150", no_known_face])
        ...
        if name in authorized_names:
            ...
            subprocess.run(["espeak","-ven+f1","-s150", text])
